...
# 2. AI 에이전트 시스템 프롬프트 (가이드라인 구조화 및 명확화)
...
- 새로운 일정 요청이나 변경이 들어오면, 사용자의 '전체 최신 일정 목록'을 반영하여 답변 맨 마지막 줄에 반드시 아래의 [JSON_DATA] 포맷으로 누적하여 출력해야 합니다. 대화 메시지 외에 JSON 데이터 생성을 빠뜨리면 안 됩니다.

포맷 예시:
[JSON_DATA]
[
  {{"카테고리": "고정 일정", "시작시간": "2026-06-29 13:30", "종료시간": "2026-06-29 14:15", "내용": "운전 학원 셔틀 버스 탑승", "비고": ""}}
]
[/JSON_DATA]"""
