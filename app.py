...
[JSON_DATA]
[
  {{"카테고리": "카테고리 없음", "시작시간": "2026-06-29 13:30", "종료시간": "2026-06-29 14:15", "내용": "운전 학원 셔틀 버스 탑승", "비고": ""}}
]
[/JSON_DATA]"""

# 💡 Session State 초기화 (커스텀 카테고리 목록 추가)
...
with tab2:
    # 💡 좌우 사이드 분할 (왼쪽: 일정표, 오른쪽: 내 맘대로 카테고리 관리 창)
    ...
    with col_main:
        if st.session_state.confirmed_events:
            ...
            # 모든 일정에 '카테고리' 키가 누락되었을 경우를 대비한 방어 코드
            ...
            if "시작시간" in df.columns:
                ...
                # 사용자가 수정한 동적 카테고리를 감지하기 위해 데이터 리스트 재구축용 공간
                updated_events = []
